...
const Moto = () => {
  ...
  const episode_6_altDescription = 'Description of the image';
  const episode_6_title = 'Episode 6';
  const episode_6_location = 'Germany';
  const episode_6_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
  ...
  const episode_5_altDescription = 'Description of the image';
  const episode_5_title = 'Episode 5';
  const episode_5_location = 'Germany';
  const episode_5_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
  ...
  const episode_4_altDescription = 'Description of the image';
  const episode_4_title = 'Episode 4';
  const episode_4_location = 'Germany';
  const episode_4_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
  ...
  const episode_3_altDescription = 'Description of the image';
  const episode_3_title = 'Episode 3';
  const episode_3_location = 'Germany';
  const episode_3_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
  ...
  const episode_2_altDescription = 'Description of the image';
  const episode_2_title = 'Episode 2';
  const episode_2_location = 'Germany';
  const episode_2_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
  ...
  const episode_1_altDescription = 'Description of the image';
  const episode_1_title = 'Episode 1';
  const episode_1_location = 'Germany';
  const episode_1_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
  ...
  const episode_trailer_altDescription = 'Description of the image';
  const episode_trailer_title = 'Trailer';
  const episode_trailer_location = 'Germany';
  const episode_trailer_description = 'Blasting on the highway on my way from Manchester, UK to Bucharest, Romania';
